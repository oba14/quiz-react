    ...
    const answerStatus = (e) => {
      ...
      return (
        <>
          ...
          <div key={index} style={{display:'flex', flexDirection:'column', flexWrap:'wrap', justifyContent:'center', alignContent:'center'}}>
       
                   <h4> Question: {question.question}</h4>
                    <div className="answers correctanswer" style={{backgroundColor: answerColor, border:'2px solid red'}} >
                        <span >A</span>

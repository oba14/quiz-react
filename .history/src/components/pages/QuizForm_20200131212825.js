...
const QuizForm = () => {
    ...
    const categories =  [{"id":9,"name":"General Knowledge"},{"id":10,"name":"Entertainment: Books"},
        ...
        <div className= "container">
            <div>
                ...
                <form  onSubmit={handleSubmit(onSubmit)} id= {'myForm'} name= {'myForm'} encType='multipart/form-data'>
                    ...
                    <input className='form-control' type="text" placeholder="reporting" name="reporting" ref={register({ required: false })} /><br />
